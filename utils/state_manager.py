...
Features:
- Real-time Dual-Write Persistence: Instant commit to SQLite & atomic JSON serialization
...
- Automatic in-memory cache sync for All 14 Cogs
"""
import os
import json
import shutil
    ...
    async with AsyncSessionLocal() as session:
        ...
        for g in res_g.scalars().all():
            ...
            state[g_key]["config"] = {
                ...
                "bot_manager_role_id": g.bot_manager_role_id
            }
        ...
        for a in res_a.scalars().all():
            ...
            state[g_key]["automod"] = {
                ...
                "block_links": a.block_links,
                "spam_threshold": a.spam_threshold,
                "mass_mention_limit": a.mass_mention_limit,
                "punishment_type": a.punishment_type,
                "punishment_duration": a.punishment_duration
            }
